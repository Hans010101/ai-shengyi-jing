...
const dataPath = path.join(__dirname, 'data', 'projects.js');
...
const baseProjects = [
  {
    ...
    category: ["AI工具", "Micro-SaaS"],
    tags: ["No-code", "独立开发", "工具类"],
    revenue: 20000,
    ...
    marketingChannels: ["SEO", "Reddit", "Product Hunt"],
    techStack: ["GPT API", "Next.js", "Stripe"],
    heroEmoji: "📊",
    heroColor: "#10B981",
    ...
    keyMetrics: { mrr: "$20,000", startupCost: "$196", timeToFirstRevenue: "30天", teamSize: "1人" },
    featured: true
  },
  {
    ...
    category: ["效率工具", "Micro-SaaS"],
    tags: ["No-code", "B2B", "数据处理"],
    revenue: 40000,
    ...
    marketingChannels: ["Google Ads", "SEO", "会计师社群"],
    techStack: ["Python", "PDF解析库", "Stripe"],
    heroEmoji: "🏦",
    heroColor: "#3B82F6",
    ...
    keyMetrics: { mrr: "$40,000", startupCost: "$100", timeToFirstRevenue: "14天", teamSize: "1人" },
    featured: true
  },
  {
    ...
    marketingChannels: ["冷邮件", "LinkedIn自身", "内容营销"],
    techStack: ["Node.js", "Chrome Extension", "PostgreSQL"],
    heroEmoji: "🤝",
    heroColor: "#0EA5E9",
    ...
    keyMetrics: { mrr: "$60,000", startupCost: "$100", timeToFirstRevenue: "120天", teamSize: "3人" },
    featured: true
  },
  {
    ...
    marketingChannels: ["冷邮件", "内容营销", "行业展会"],
    techStack: ["OpenAI Vision", "Python", "AWS", "Stripe"],
    heroEmoji: "📄",
    heroColor: "#8B5CF6",
    ...
    keyMetrics: { mrr: "$40,000", startupCost: "$1,000", timeToFirstRevenue: "365天", teamSize: "2人" },
    featured: false
  },
  {
    ...
    marketingChannels: ["SEO", "Google", "社交媒体"],
    techStack: ["Ruby on Rails", "PostgreSQL", "Google Adsense"],
    heroEmoji: "✈️",
    heroColor: "#F59E0B",
    ...
    keyMetrics: { mrr: "$20,000", startupCost: "$100", timeToFirstRevenue: "60天", teamSize: "1人" },
    featured: false
  },
  {
    ...
    category: ["B2B SaaS", "营销技术"],
    tags: ["CRM", "Analytics", "B2B", "MarTech"],
    revenue: 100000,
    ...
    marketingChannels: ["内容营销", "合作伙伴", "销售团队"],
    ...
    keyMetrics: { mrr: "$100,000", startupCost: "$1,000", timeToFirstRevenue: "30天", teamSize: "5人" },
    featured: true
  },
  {
    ...
    marketingChannels: ["Twitter/X", "Newsletter", "播客", "YouTube"],
    techStack: ["Kajabi", "Substack", "Circle"],
    heroEmoji: "🎓",
    heroColor: "#14B8A6",
    ...
    keyMetrics: { mrr: "$100,000", startupCost: "$1,000", timeToFirstRevenue: "90天", teamSize: "1人" },
    featured: true
  },
  {
    id: "no-code-agency",
    ...
    marketingChannels: ["LinkedIn", "口碑推荐", "Upwork"],
    techStack: ["Bubble", "Webflow", "Zapier", "Airtable"],
    heroEmoji: "🚀",
    heroColor: "#A855F7",
    ...
    keyMetrics: { mrr: "$100,000", startupCost: "$0", timeToFirstRevenue: "30天", teamSize: "5人" },
    featured: true
  },
  {
    ...
    marketingChannels: ["TikTok", "Instagram", "YouTube"],
    techStack: ["Python", "Stable Diffusion", "FFmpeg", "AWS"],
    heroEmoji: "🎵",
    heroColor: "#F97316",
    ...
    keyMetrics: { mrr: "$20,000", startupCost: "$500", timeToFirstRevenue: "40天", teamSize: "2人" },
    featured: false
  },
  {
    ...
    marketingChannels: ["YouTube", "SEO", "Email"],
    techStack: ["Teachable", "Notion", "Loom"],
    heroEmoji: "🌐",
    heroColor: "#6366F1",
    ...
    keyMetrics: { mrr: "$40,000", startupCost: "$500", timeToFirstRevenue: "30天", teamSize: "1人" },
    featured: false
  },
  {
    ...
    category: ["Micro-SaaS", "数据工具"],
    tags: ["No-code", "BI", "数据分析"],
    revenue: 10000,
    ...
    teamSize: 1,
    businessModel: "SaaS订阅",
    marketingChannels: ["Product Hunt", "Twitter", "IndieHackers"],
    ...
    keyMetrics: { mrr: "$10,000", startupCost: "$500", timeToFirstRevenue: "7天", teamSize: "1人" },
    featured: false
  },
  {
    ...
    marketingChannels: ["Twitter/X", "LinkedIn", "推荐裂变", "播客"],
    techStack: ["Substack", "Beehiiv", "ConvertKit"],
    heroEmoji: "📬",
    heroColor: "#84CC16",
    ...
    keyMetrics: { mrr: "$50,000", startupCost: "$0", timeToFirstRevenue: "180天", teamSize: "1人" },
    featured: false
  },
  {
    ...
    marketingChannels: ["TikTok", "Instagram", "Pinterest", "口碑"],
    ...
    keyMetrics: { mrr: "$83,000", startupCost: "$5,000", timeToFirstRevenue: "180天", teamSize: "3人" },
    featured: false
  },
  {
    ...
    marketingChannels: ["谷歌本地广告", "Nextdoor", "口碑"],
    techStack: ["专业高压水枪设备", "预约系统App"],
    heroEmoji: "💧",
    heroColor: "#06B6D4",
    ...
    keyMetrics: { mrr: "$30,000", startupCost: "$3,000", timeToFirstRevenue: "14天", teamSize: "2人" },
    featured: false
  },
  {
    ...
    category: ["效率工具", "Micro-SaaS"],
    tags: ["Airtable", "自动化", "No-code", "平台生态"],
    revenue: 20000,
    revenueDisplay: "$20K/月",
    startupCost: 100,
    startupDays: 90,
    ...
    teamSize: 1,
    businessModel: "SaaS订阅",
    marketingChannels: ["Airtable社区", "ProductHunt", "Reddit"],
    techStack: ["Node.js", "Airtable API", "Stripe"],
    heroEmoji: "🔄",
    heroColor: "#22C55E",
    ...
    keyMetrics: { mrr: "$20,000", startupCost: "$100", timeToFirstRevenue: "90天", teamSize: "1人" },
    featured: false
  }
];
...
templates.forEach(group => {
  group.items.forEach(item => {
    const [nameZh, nameEn, rev, revDisp, cost, days, summary] = item;
    if (newProjects.some(p => p.name === nameZh)) return;

    const color = group.colors[Math.floor(Math.random() * group.colors.length)];
    const score = Math.floor(Math.random() * 4) + 6;
    const team = [1, 1, 1, 2, 3][Math.floor(Math.random() * 5)];

    newProjects.push({
      id: `auto-proj-${idCounter++}`,
      name: nameZh,
      nameEn: nameEn,
      category: group.cat,
      tags: group.tags,
      ...
      difficulty: ["低", "中", "低中"][Math.floor(Math.random() * 3)],
      teamSize: team,
      ...
      productArch: `前端界面 (${group.cat[0]}) ➔ 后端处理管道 ➔ 核心 API 服务 ➔ 支付与交付模块。`,
      ...
      keyMetrics: { mrr: revDisp, startupCost: `$${cost}`, timeToFirstRevenue: `${days}天`, teamSize: `${team}人` },
      featured: false
    });
  });
});

const fileContent = `// AI生意经 - 精选全球 AI 与数字小生意数据库
// 数据来源：全球 AI 与数字小生意大盘 | AI生意经团队独家拆解
// 最后更新：2026-07-21

const PROJECTS = ${JSON.stringify(newProjects, null, 2)};
...
console.log(`Successfully updated projects.js! Total projects now: ${newProjects.length}`);
